...
const handleRoomTypeChange=(selectedType)=>{
    ...
    <div className='modal-backdrop'>
        <div className='modal-content'>
            ...
            <div className='modal-filters-conatiner'>
                ...
                <div className='filter-section'>
                    ...
                    <div className='icon-box'>{propertyTypeOptions.map((options)=>(
                        <div key={options.value}
                        className={'selectable-box ${propertyType === options.value ? "selected":""}'} onClick={()=>handlePropertyTypeChange(options.value)}>
                  ...
                  <div className='filter-section'>
                    ...
                    <div className='icon-box'>{roomTypeOptions.map((options)=>(
                        <div key={options.value}
                    ...
                    <div className='filter-section'>
                       ...
                       <div className='amenities-checkboxes'>{amenitiesOptions.map((options)=>(
                        ...
                        />
                        <span className='material-icons amenities labels'>{options.icon}</span>
